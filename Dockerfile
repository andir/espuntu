...
RUN apt-get update && apt-get install -y make unrar autoconf automake libtool libtool gcc g++ gperf flex bison texinfo gawk ncurses-dev libexpat1-dev python sed python-serial srecord bc git wget bzip2 unzip libtool-bin
